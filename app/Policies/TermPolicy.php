...
class TermPolicy
{
    ...
    {
        return $user->can('delete_any_term');
    }
    ...
    {
        return $user->can('force_delete_any_term');
    }
    ...
    {
        return $user->can('restore_any_term');
    }
    ...
    {
        return $user->can('replicate_term');
    }
