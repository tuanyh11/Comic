...
class GenrePolicy
{
    ...
    {
        return $user->can('force_delete_genre');
    }
    ...
    {
        return $user->can('force_delete_any_genre');
    }
    ...
    {
        return $user->can('restore_any_genre');
    }
    ...
    {
        return $user->can('replicate_genre');
    }
